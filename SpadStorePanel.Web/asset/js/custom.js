...
$('.countdown-time').each(function () {
    ...
    $(this).countdown(endTime, function (tm) {
        $(this).html(tm.strftime('<span class="countdown-box"><span class="countdown days">%D </span><span class="cd-text">روز</span></span><span class="countdown-box"><span class="countdown hours">%H</span><span class="cd-text">ساعت</span></span><span class="countdown-box"><span class="countdown minutes">%M</span><span class="cd-text">دقیقه</span></span><span class="countdown-box"><span class="countdown seconds">%S</span><span class="cd-text">ثانیه</span></span>'));
    });
});
/*===================================*
26.SEARCH OPEN JS
